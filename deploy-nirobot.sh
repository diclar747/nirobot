#!/bin/sh
# Despliega NiroBot (db + api + web) y publica nirobot.cnid.com.py vía Traefik de Dokploy.
set -e
...
for i in $(seq 1 40); do
  code=$(curl -s -o /dev/null -w '%{http_code}' https://nirobot.cnid.com.py/health || true)
