...
const PERMISSIONS = [
  ...
  { key: 'groups',         group: 'Contactos',  label: 'Grupos de WhatsApp',        description: 'Ver, sincronizar y exportar los grupos y sus integrantes.' },
  ...
  { key: 'history',        group: 'Gestión',    label: 'Historial',                 description: 'Ver y exportar el historial completo de mensajes.' },
