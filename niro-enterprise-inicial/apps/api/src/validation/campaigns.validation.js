...
const createCampaignSchema = z.object({
  ...
  if (data.tagFilter.length === 0 && data.contactIds.length === 0) {
    ctx.addIssue({ code: z.ZodIssueCode.custom, path: ['audience'], message: 'Seleccioná al menos una etiqueta o un contacto' });
  }
