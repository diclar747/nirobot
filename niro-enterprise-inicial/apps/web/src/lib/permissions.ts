...
export type PermissionKey =
  | 'campaigns' | 'statuses' | 'calls' | 'contacts' | 'groups' | 'contactsExport' | 'contactsDelete'
  | 'crm' | 'orders' | 'quickReplies' | 'transferChats' | 'reports' | 'history' | 'management' | 'sms' | 'bot' | 'aiAgents' | 'developers';
